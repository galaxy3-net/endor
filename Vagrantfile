...
Vagrant.configure("2") do |config|
  ...
  config.vm.network "forwarded_port", guest: 3389, host: 55034,  auto_correct: true
  config.vm.network "forwarded_port", guest: 8000, host: 58000,  auto_correct: true
  config.vm.network "forwarded_port", guest: 80,  auto_correct: true
